...
{
    public class SearchingClass(IConfiguration configuration)
    {
        public string searchResponseText { get; set; }
        GetUidList getUidList = new GetUidList(configuration);
        DashboardJson dashboardJson = new DashboardJson(configuration);
